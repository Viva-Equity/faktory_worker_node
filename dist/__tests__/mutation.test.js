...
(0, ava_1.default)("integration: #clear discards all retries", async (t) => {
...
(0, ava_1.default)("integration: #kill moves retries to dead", async (t) => {
    const client = new client_1.Client();
    await client.connect();
    await client.job("fail").push();
    const job = await client.fetch("default");
...
(0, ava_1.default)("integration: #kill moves scheduled to dead", async (t) => {
    const client = new client_1.Client();
    await client.connect();
...
(0, ava_1.default)("integration: #requeue moves retries to queue", async (t) => {
    const client = new client_1.Client();
    await client.connect();
    await client.job("fail").push();
    const job = await client.fetch("default");
...
(0, ava_1.default)("#clear clears retries", async (t) => {
    t.plan(1);
...
(0, ava_1.default)("#clear clears scheduled jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#clear clears dead jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#kill kills retries", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#kill kills scheduled jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#kill kills dead jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#discard discards retries", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#discard discards scheduled jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#discard discards dead jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#requeue requeues retries", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#requeue requeues scheduled jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#requeue requeues dead jobs", async (t) => {
    t.plan(1);
    await (0, _helper_1.mocked)(async (server, port) => {
        const client = new client_1.Client({ port });
        server.on("MUTATE", ({ data, socket }) => {
...
(0, ava_1.default)("#matching disallows nonstrings", (t) => {
    t.throws(() => {
...
(0, ava_1.default)("#ofType disallows nonstring argument", (t) => {
    t.throws(() => {
        const mutation = new mutation_1.Mutation(new client_1.Client());
        const MyJob = () => { };
        // @ts-ignore
